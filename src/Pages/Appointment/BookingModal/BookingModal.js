...
const BookingModal = ({ treatment, setTreatment, selectedDate, refetch }) => {
    //treatment is just another name of appointmentOptions with name and slot, _id
    ...
    const handleBooking = event => {
        ...
        const booking = {
            ...
            slot,
            email,
            phone, // same name hoile phone = phone aivabe na likhleo chole
            price
        }
        // TODO: send data to the server
        //and once data is saved then close the modal and display toast
